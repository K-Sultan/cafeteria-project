                            ...
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm font-medium space-x-3">
                                        <a href="/users/edit?id=<?= $user['id'] ?>" class="text-indigo-400 hover:text-indigo-300">Edit</a>
                                        <a href="/users/delete?id=<?= $user['id'] ?>" class="text-red-400 hover:text-red-300" onclick="return confirm('Are you sure?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
