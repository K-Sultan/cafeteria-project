				...
				<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
					...
					<div>
						...
						<div class="flex gap-2">
							...
							<button type="button" onclick="openCategoryModal()" class="inline-flex items-center justify-center rounded-xl bg-gray-800/80 px-4 py-3 text-sm font-medium text-gray-200 ring-1 ring-gray-700 hover:bg-gray-700/80 transition-colors whitespace-nowrap">
								+ Add
							</button>
						</div>
					</div>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md ring-1 ring-gray-700">
                ...
                <div class="bg-gray-800/50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" onclick="saveCategory()" class="inline-flex w-full justify-center rounded-xl bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 sm:ml-3 sm:w-auto transition-colors">Save</button>
                    <button type="button" onclick="closeCategoryModal()" class="mt-3 inline-flex w-full justify-center rounded-xl bg-gray-700 px-3 py-2 text-sm font-semibold text-gray-200 shadow-sm ring-1 ring-inset ring-gray-600 hover:bg-gray-600 sm:mt-0 sm:w-auto transition-colors">Cancel</button>
                </div>
            </div>
        </div>
    </div>
